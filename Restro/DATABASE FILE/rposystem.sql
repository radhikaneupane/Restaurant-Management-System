...
('10e0b6dc958adfb5b094d8935a13aeadbe783c25', 'System Admin', 'admin@mail.com', '53b201059751d0f5968f2d1cbf98a0f1d4d7220d');
...
CREATE TABLE `rpos_waiter` (
  `waiter_id` int(20) NOT NULL,
  `waiter_name` varchar(200) NOT NULL,
  `waiter_number` varchar(200) NOT NULL,
  `waiter_email` varchar(200) NOT NULL,
  `waiter_password` varchar(200) NOT NULL,
  `created_at` timestamp(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `rpos_waiter` (`waiter_id`, `waiter_name`, `waiter_number`, `waiter_email`, `waiter_password`, `created_at`) VALUES
(3, 'darkseid', 'JIAV-5178', 'darkseid@gmail.com', '53b201059751d0f5968f2d1cbf98a0f1d4d7220d', '2022-09-19 01:17:38.459822');
...
--
-- Indexes for table `rpos_waiter`
--
ALTER TABLE `rpos_waiter`
...
--
-- AUTO_INCREMENT for table `rpos_waiter`
--
ALTER TABLE `rpos_waiter`
  MODIFY `waiter_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
